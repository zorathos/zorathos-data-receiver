    ...
    public void start() {
        ...
        String sourceSql = MessageFormat.format("""
                CREATE TABLE `equipment_info_source` (
                    ...
                    WATERMARK FOR create_time AS create_time - INTERVAL '5' SECOND,  -- 定义水位线
        ...
        Table sourceTable = tableEnvironment.from("equipment_info_source");

        sourceTable.select(
                $("id"), $("create_time"), $("create_people"), $("update_time"), $("update_people"),
                $("old_id"), $("plane_type"), $("equipment_type"), $("plane_weight"), $("parent_id"),
                $("threetype_system"), $("is_deleted"), $("equipment_model"), $("unit"), $("work_band"),
                $("longitude"), $("latitude"), $("is_three_back")
                        )
