...
/**
 * @author : [wangminan]
 * @description : 呼吸应变文件接收器
 */
public class TShirtRespFileReceiver extends PhysiologicalFileReceiver<TShirtResp> {
    @Override
    public void prepare() {
        table = TiDBTable.T_SHIRT_RESP;
        modelClass = TShirtResp.class;
        super.prepare();
    }
    ...
    @Override
    public void bindPreparedStatement(PreparedStatement preparedStatement, TShirtResp data, Long importId) throws SQLException {
        ...
        preparedStatement.setObject(6, data.getRespData());
    ...
    public static void main(String[] args) {
        ...
        TShirtRespFileReceiver receiver = new TShirtRespFileReceiver();
