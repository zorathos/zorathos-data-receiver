 ...
 * @description : 手环血氧接收器
 */
public class WristBandSpo2FileReceiver extends PhysiologicalFileReceiver<WristBandSpo2> {
    @Override
    public void prepare() {
        table = TiDBTable.WRISTBAND_SPO2;
        modelClass = WristBandSpo2.class;
        super.prepare();
    }
    ...
    public void bindPreparedStatement(PreparedStatement preparedStatement, WristBandSpo2 data, Long importId) throws SQLException {
        ...
        preparedStatement.setObject(6, data.getSpo2());
    ...
    public static void main(String[] args) {
        ...
        WristBandSpo2FileReceiver receiver = new WristBandSpo2FileReceiver();
