...
public class TShirtEcgAccelGyroFileReceiver extends PhysiologicalFileReceiver<TShirtEcgAccelGyro> {
    ...
    public void bindPreparedStatement(PreparedStatement preparedStatement, TShirtEcgAccelGyro data, Long importId) throws SQLException {
        ...
        preparedStatement.setObject(6, data.getEcg1());
        preparedStatement.setObject(7, data.getEcg2());
        preparedStatement.setObject(8, data.getEcg3());
        preparedStatement.setObject(9, data.getAccelX());
        preparedStatement.setObject(10, data.getAccelY());
        preparedStatement.setObject(11, data.getAccelZ());
        preparedStatement.setObject(12, data.getGyroX());
        preparedStatement.setObject(13, data.getGyroY());
        preparedStatement.setObject(14, data.getGyroZ());
        preparedStatement.setLong(15, importId);
    }
