        ...
        SinkFunction<EyeMovement> eyeMovementSink = JdbcSink.sink(
                """
                        INSERT INTO eye_movement (
                            ...
                            validity_left,
                            validity_right,
                            pupil_position_left_x,
                            pupil_position_left_y,
                            pupil_position_right_x,
                            pupil_position_right_y,
                            pupil_diameter_left_px,
                            pupil_diameter_left_mm,
                            pupil_diameter_right_px,
                            pupil_diameter_right_mm,
                            openness_left,
                            openness_right,
                            eyelid_distance_left_px,
                            eyelid_distance_left_mm,
                            eyelid_distance_right_px,
                            eyelid_distance_right_mm,
                            ipd,
                            gaze_point_index,
                            gaze_point_x,
                            gaze_point_y,
                        ...
                        ON DUPLICATE KEY UPDATE
                            ...
                            valid_ratio = VALUES(valid_ratio),
                            time_of_day = VALUES(time_of_day),
                            video_time = VALUES(video_time),
                            recording_time_stamp = VALUES(recording_time_stamp),
                            gaze_velocity = VALUES(gaze_velocity),
                            serial_send = VALUES(serial_send),
                            serial_receive = VALUES(serial_receive),
                            udp_send = VALUES(udp_send),
                            udp_receive = VALUES(udp_receive),
                            event_label = VALUES(event_label),
                            annotation = VALUES(annotation),
                            validity_left = VALUES(validity_left),
                            validity_right = VALUES(validity_right),
                            pupil_position_left_x = VALUES(pupil_position_left_x),
                            pupil_position_left_y = VALUES(pupil_position_left_y),
                            pupil_position_right_x = VALUES(pupil_position_right_x),
                            pupil_position_right_y = VALUES(pupil_position_right_y),
                            pupil_diameter_left_px = VALUES(pupil_diameter_left_px),
                            pupil_diameter_left_mm = VALUES(pupil_diameter_left_mm),
                            pupil_diameter_right_px = VALUES(pupil_diameter_right_px),
                            pupil_diameter_right_mm = VALUES(pupil_diameter_right_mm),
                            openness_left = VALUES(openness_left),
                            openness_right = VALUES(openness_right),
                            eyelid_distance_left_px = VALUES(eyelid_distance_left_px),
                            eyelid_distance_left_mm = VALUES(eyelid_distance_left_mm),
                            eyelid_distance_right_px = VALUES(eyelid_distance_right_px),
                            eyelid_distance_right_mm = VALUES(eyelid_distance_right_mm),
                            ipd = VALUES(ipd),
                            gaze_point_index = VALUES(gaze_point_index),
                            gaze_point_x = VALUES(gaze_point_x),
                            gaze_point_y = VALUES(gaze_point_y),
                            x_offset = VALUES(x_offset),
                            y_offset = VALUES(y_offset),
                            gaze_point_left_x = VALUES(gaze_point_left_x),
                            gaze_point_left_y = VALUES(gaze_point_left_y),
                            gaze_point_right_x = VALUES(gaze_point_right_x),
                            gaze_point_right_y = VALUES(gaze_point_right_y),
                            gaze_origin_left_x = VALUES(gaze_origin_left_x),
                            gaze_origin_left_y = VALUES(gaze_origin_left_y),
                            gaze_origin_left_z = VALUES(gaze_origin_left_z),
                            gaze_origin_right_x = VALUES(gaze_origin_right_x),
                            gaze_origin_right_y = VALUES(gaze_origin_right_y),
                            gaze_origin_right_z = VALUES(gaze_origin_right_z),
                            gaze_direction_left_x = VALUES(gaze_direction_left_x),
                            gaze_direction_left_y = VALUES(gaze_direction_left_y),
                            gaze_direction_left_z = VALUES(gaze_direction_left_z),
                            gaze_direction_right_x = VALUES(gaze_direction_right_x),
                            gaze_direction_right_y = VALUES(gaze_direction_right_y),
                            gaze_direction_right_z = VALUES(gaze_direction_right_z),
                            fixation_index = VALUES(fixation_index),
                            fixation_duration = VALUES(fixation_duration),
                            fixation_point_x = VALUES(fixation_point_x),
                            fixation_point_y = VALUES(fixation_point_y),
                            saccade_index = VALUES(saccade_index),
                            saccade_duration = VALUES(saccade_duration),
                            saccade_amplitude = VALUES(saccade_amplitude),
                            saccade_velocity_average = VALUES(saccade_velocity_average),
                            saccade_velocity_peak = VALUES(saccade_velocity_peak),
                            invalid_index = VALUES(invalid_index),
                            invalid_duration = VALUES(invalid_duration),
                            blink_index = VALUES(blink_index),
                            blink_duration = VALUES(blink_duration),
                            blink_eye = VALUES(blink_eye),
                            quat_data = VALUES(quat_data),
                            gyro = VALUES(gyro),
                            accel = VALUES(accel),
                            mag = VALUES(mag);
