    ...
    public void start() {
        ...
        Sink<MotionCapture> sinkFunction = JdbcSink.<MotionCapture>builder()
                .withQueryStatement("""
                    ...
                    preparedStatement.setLong(10, motionCapture.getHipsTimestamp());
                    ...
                    preparedStatement.setLong(17, motionCapture.getJointTagSpineTimestamp());
                    ...
                    preparedStatement.setLong(24, motionCapture.getJointTagSpine1Timestamp());
                    ...
                    preparedStatement.setLong(31, motionCapture.getJointTagSpine2Timestamp());
                    ...
                    preparedStatement.setLong(38, motionCapture.getJointTagNeckTimestamp());
                    ...
                    preparedStatement.setLong(45, motionCapture.getJointTagNeck1Timestamp());
                    ...
                    preparedStatement.setLong(52, motionCapture.getJointTagHeadTimestamp());
                    ...
                    preparedStatement.setLong(59, motionCapture.getJointTagRightShoulderTimestamp());
                    ...
                    preparedStatement.setLong(66, motionCapture.getJointTagRightArmTimestamp());
                    ...
                    preparedStatement.setLong(73, motionCapture.getJointTagRightForeArmTimestamp());
                    ...
                    preparedStatement.setLong(80, motionCapture.getJointTagRightHandTimestamp());
                    ...
                    preparedStatement.setLong(87, motionCapture.getJointTagRightInHandIndexTimestamp());
                    ...
                    preparedStatement.setLong(94, motionCapture.getJointTagRightInHandMiddleTimestamp());
                    ...
                    preparedStatement.setLong(101, motionCapture.getJointTagLeftShoulderTimestamp());
                    ...
                    preparedStatement.setLong(108, motionCapture.getJointTagLeftArmTimestamp());
                    ...
                    preparedStatement.setLong(115, motionCapture.getJointTagLeftForeArmTimestamp());
                    ...
                    preparedStatement.setLong(122, motionCapture.getJointTagLeftHandTimestamp());
                    ...
                    preparedStatement.setLong(129, motionCapture.getJointTagLeftInHandIndexTimestamp());
                    ...
                    preparedStatement.setLong(136, motionCapture.getJointTagLeftInHandMiddleTimestamp());
                })
