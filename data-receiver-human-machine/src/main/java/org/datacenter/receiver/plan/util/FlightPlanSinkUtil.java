...
public class FlightPlanSinkUtil {
    public static Sink<FlightPlanRoot> flightRootSink = JdbcSink.<FlightPlanRoot>builder()
            .withQueryStatement(
                    """
    ...
    public static Sink<FlightHead> flightHeadSink = JdbcSink.<FlightHead>builder()
            .withQueryStatement(
                    """
    ...
    public static Sink<FlightNotes> flightNotesSink = JdbcSink.<FlightNotes>builder()
            .withQueryStatement(
                    """
    ...
    public static Sink<FlightCmd> flightCmdSink = JdbcSink.<FlightCmd>builder()
            .withQueryStatement(
                    """
    ...
    public static Sink<FlightTask> flightTaskSink = JdbcSink.<FlightTask>builder()
            .withQueryStatement(
                    """
    ...
    public static Sink<FlightPlan> flightPlanSink = JdbcSink.<FlightPlan>builder()
            .withQueryStatement(
                    """
    ...
    public static void addMultiSinkForFlightPlanRoot(SingleOutputStreamOperator<FlightPlanRoot> sourceDs) {
        sourceDs.sinkTo(FlightPlanSinkUtil.flightRootSink).name("Flight root sink");
        sourceDs.map(FlightPlanRoot::getFlightHead)
                .returns(FlightHead.class)
                .sinkTo(FlightPlanSinkUtil.flightHeadSink).name("Flight head sink");
        sourceDs.map(FlightPlanRoot::getFlightNotes)
                .returns(FlightNotes.class)
                .sinkTo(FlightPlanSinkUtil.flightNotesSink).name("Flight notes sink");
        sourceDs.flatMap((FlightPlanRoot root, Collector<FlightCmd> out) -> root.getFlightCommands()
                        .forEach(out::collect))
                .returns(FlightCmd.class)
                .sinkTo(FlightPlanSinkUtil.flightCmdSink).name("Flight command sink");
        sourceDs.flatMap((FlightPlanRoot root, Collector<FlightTask> out) -> root.getFlightTasks()
                        .forEach(out::collect))
                .returns(FlightTask.class)
                .sinkTo(FlightPlanSinkUtil.flightTaskSink).name("Flight task sink");
        sourceDs.flatMap((FlightPlanRoot root, Collector<FlightPlan> out) -> root.getFlightPlans()
                        .forEach(out::collect))
                .returns(FlightPlan.class)
                .sinkTo(FlightPlanSinkUtil.flightPlanSink).name("Flight plan sink");
    }
}
