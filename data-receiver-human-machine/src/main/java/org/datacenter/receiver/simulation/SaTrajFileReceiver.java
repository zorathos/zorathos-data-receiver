...
public class SaTrajFileReceiver extends SimulationReceiver<SaTraj> {
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, SaTraj data, String batchNumber, long importId) throws SQLException {
        ...
        preparedStatement.setString(12, data.getInterceptedWeaponId());
        ...
        preparedStatement.setString(16, data.getMissileTargetDistance());
        preparedStatement.setString(17, data.getMissileSpeed());
        preparedStatement.setString(18, data.getInterceptionStatus());
        preparedStatement.setString(19, data.getNonInterceptionReason());
        preparedStatement.setString(20, data.getSeekerAzimuth());
        preparedStatement.setString(21, data.getSeekerElevation());
        preparedStatement.setString(22, data.getTargetTspiStatus());
        preparedStatement.setString(23, data.getCommandMachineStatus());
    }
