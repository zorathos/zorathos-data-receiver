...
public class AaTrajFileReceiver extends SimulationReceiver<AaTraj> {
    ...
    protected SerializableFunction<CsvMapper, CsvSchema> getSchemaGenerator() {
        return mapper -> CsvSchema.builder()
                ...
                .addColumn("weaponId")
                .addColumn("weaponPylonId")
                .addColumn("aircraftLongitude")
                .addColumn("aircraftLatitude")
                .addColumn("aircraftAltitude")
                .addColumn("weaponLongitude")
                .addColumn("weaponLatitude")
                .addColumn("weaponAltitude")
                .addColumn("missileLongitude")
                .addColumn("missileLatitude")
                .addColumn("missileAltitude")
                .addColumn("missileHeading")
                .addColumn("missilePitch")
                .addColumn("missileRoll")
                .addColumn("pylonId")
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, AaTraj data, String batchNumber, long importId) throws SQLException {
...
//        LocalDate localDate = LocalDate.parse(sortieNumber.split("_")[0], DateTimeFormatter.ofPattern("yyyyMMdd"));
        ...
        preparedStatement.setTime(4, Time.valueOf(data.getMessageTime()));
        preparedStatement.setTime(5, Time.valueOf(data.getSatelliteGuidanceTime()));
        preparedStatement.setTime(6, Time.valueOf(data.getLocalTime()));
