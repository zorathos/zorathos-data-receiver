...
public class EwsKJ500FileReceiver extends SimulationReceiver<EwsKJ500> {
    ...
    protected String getInsertQuery() {
        return """
                INSERT INTO `ews_kj500` (
                    import_id,batch_number, aircraft_id, message_time, satellite_guidance_time, local_time, message_sequence_number, azimuth_start_angle, sector_reference, sector_type, sector_number, 
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, EwsKJ500 data, String batchNumber, long importId) throws SQLException {
        ...
        preparedStatement.setString(8, data.getAzimuthStartAngle());
        preparedStatement.setString(9, data.getSectorReference());
        preparedStatement.setString(10, data.getSectorType());
        preparedStatement.setString(11, data.getSectorNumber());
        preparedStatement.setString(12, data.getActionCode());
        preparedStatement.setString(13, data.getAzimuthEndAngle());
    }
