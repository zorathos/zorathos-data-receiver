...
public class RdrStateFileReceiver extends SimulationBaseReceiver<RdrState> {
...
INSERT INTO `rdr_state` (
    sortie_number, aircraft_id, message_time, satellite_guidance_time, local_time, message_sequence_number, working_mode, air_sea_scan_ratio, power_status, emission_status
) VALUES (
    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
);
""";
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, RdrState data, String sortieNumber) throws SQLException {
// 注意 sortieNumber 是从配置里面来的 csv里面没有
        ...
        preparedStatement.setString(8, data.getAirSeaScanRatio());
        preparedStatement.setString(9, data.getPowerStatus());
        preparedStatement.setString(10, data.getEmissionStatus());
    }
