...
public class SaTgtFileReceiver extends SimulationReceiver<SaTgt> {
    ...
    protected String getInsertQuery() {
        return """
                INSERT INTO `sa_tgt` (
                    import_id,batch_number, ground_defense_id, message_time, satellite_guidance_time, local_time, message_sequence_number, equipment_type, equipment_number, target_azimuth, 
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, SaTgt data, String batchNumber, long importId) throws SQLException {
        ...
        preparedStatement.setString(10, data.getTargetAzimuth());
        preparedStatement.setString(11, data.getTargetElevation());
        preparedStatement.setString(12, data.getTargetSlantRange());
        preparedStatement.setString(13, data.getChannelNumber());
        preparedStatement.setString(14, data.getTargetBatchNumber());
    }
