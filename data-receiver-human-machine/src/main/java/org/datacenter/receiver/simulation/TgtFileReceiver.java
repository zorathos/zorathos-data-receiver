...
public class TgtFileReceiver extends SimulationBaseReceiver<Tgt> {
...
""";
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, Tgt data, String sortieNumber) throws SQLException {
// 注意 sortieNumber 是从配置里面来的 csv里面没有
        ...
        preparedStatement.setString(7, data.getTargetCount());
        preparedStatement.setString(8, data.getIdentifier1());
        preparedStatement.setString(9, data.getSensor1());
        preparedStatement.setString(10, data.getPitch1());
        preparedStatement.setString(11, data.getAzimuth1());
        preparedStatement.setString(12, data.getSlantRange1());
        preparedStatement.setString(13, data.getIdentifier2());
        preparedStatement.setString(14, data.getSensor2());
        preparedStatement.setString(15, data.getPitch2());
        preparedStatement.setString(16, data.getAzimuth2());
        preparedStatement.setString(17, data.getSlantRange2());
        preparedStatement.setString(18, data.getIdentifier3());
        preparedStatement.setString(19, data.getSensor3());
        preparedStatement.setString(20, data.getPitch3());
        preparedStatement.setString(21, data.getAzimuth3());
        preparedStatement.setString(22, data.getSlantRange3());
        preparedStatement.setString(23, data.getIdentifier4());
        preparedStatement.setString(24, data.getSensor4());
        preparedStatement.setString(25, data.getPitch4());
        preparedStatement.setString(26, data.getAzimuth4());
        preparedStatement.setString(27, data.getSlantRange4());
        preparedStatement.setString(28, data.getIdentifier5());
        preparedStatement.setString(29, data.getSensor5());
        preparedStatement.setString(30, data.getPitch5());
        preparedStatement.setString(31, data.getAzimuth5());
        preparedStatement.setString(32, data.getSlantRange5());
        preparedStatement.setString(33, data.getIdentifier6());
        preparedStatement.setString(34, data.getSensor6());
        preparedStatement.setString(35, data.getPitch6());
        preparedStatement.setString(36, data.getAzimuth6());
        preparedStatement.setString(37, data.getSlantRange6());
        preparedStatement.setString(38, data.getIdentifier7());
        preparedStatement.setString(39, data.getSensor7());
        preparedStatement.setString(40, data.getPitch7());
        preparedStatement.setString(41, data.getAzimuth7());
        preparedStatement.setString(42, data.getSlantRange7());
        preparedStatement.setString(43, data.getIdentifier8());
        preparedStatement.setString(44, data.getSensor8());
        preparedStatement.setString(45, data.getPitch8());
        preparedStatement.setString(46, data.getAzimuth8());
        preparedStatement.setString(47, data.getSlantRange8());
    }
