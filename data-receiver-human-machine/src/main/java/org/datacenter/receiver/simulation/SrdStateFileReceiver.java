...
public class SrdStateFileReceiver extends SimulationReceiver<SrdState> {
    ...
    protected String getInsertQuery() {
        return """
                INSERT INTO `srd_state` (
                    import_id,batch_number, ground_defense_id, message_time, satellite_guidance_time, local_time, message_sequence_number, camp_type, equipment_type, equipment_number, power_on, 
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, SrdState data, String batchNumber, long importId) throws SQLException {
        ...
        preparedStatement.setString(10, data.getEquipmentNumber());
        preparedStatement.setString(11, data.getPowerOn());
        preparedStatement.setString(12, data.getEmitterFrequencyBand());
        preparedStatement.setString(13, data.getDecoyBlinkPeriod());
        preparedStatement.setString(14, data.getAntennaPointing());
    }
