...
public class EwsY8GFileReceiver extends SimulationBaseReceiver<EwsY8G> {
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, EwsY8G data, String sortieNumber) throws SQLException {
        ...
        preparedStatement.setString(7, data.getXBandJammingElevation());
        preparedStatement.setString(8, data.getCBandJammingElevation());
        preparedStatement.setString(9, data.getCBandJammingAzimuth());
        preparedStatement.setString(10, data.getSBandJammingElevation());
        preparedStatement.setString(11, data.getSBandJammingAzimuth());
        preparedStatement.setString(12, data.getLBandJammingElevation());
        preparedStatement.setString(13, data.getLBandJammingAzimuth());
        preparedStatement.setString(14, data.getUBandJammingAzimuth());
        preparedStatement.setString(15, data.getJammingStatus());
        preparedStatement.setString(16, data.getXBandJammingAzimuthAngle());
    }
