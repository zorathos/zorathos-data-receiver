...
public class PlaneProFileReceiver extends SimulationBaseReceiver<PlanePro> {
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, PlanePro data, String sortieNumber) throws SQLException {
