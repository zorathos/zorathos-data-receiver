...
public class TspiFileReceiver extends SimulationBaseReceiver<Tspi> {
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, Tspi data, String sortieNumber) throws SQLException {
