...
/**
 * @author : [宁]
 * @description : 仿真数据Tspi的接收器
 */
@Slf4j
@Data
@EqualsAndHashCode(callSuper = true)
public class TspiFileReceiver extends SimulationReceiver<Tspi> {

    @Override
    public void prepare() {
        table = TiDBTable.TSPI;
        modelClass = Tspi.class;
        super.prepare();
    }
    ...
    @Override
    protected void bindPreparedStatement(PreparedStatement preparedStatement, Tspi data, String batchNumber, long importId) throws SQLException {
